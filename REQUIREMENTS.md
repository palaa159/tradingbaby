...
| ใคร | ทำอะไร |
|---|---|
| **ทารก / นักเรียน** (หลายตัว) | ตัวละคร AI ที่มีตัวตน นิสัย แผนผังความรู้ ไดอารี่ และพอร์ตทดลองของตัวเอง |
| **ครูใหญ่ (Principal)** | AI อีกตัวที่ไม่ใช่นักเรียน — ช่วยคนสร้างดูแลนักเรียนและ*ตัวอาคารโรงเรียน* (โค้ดของแอป): รับคำร้องจากนักเรียน แก้โค้ด merge อัตโนมัติ แล้วรายงานคนสร้าง (ข้อ 9.4) |
| **คนสร้าง (maker)** | เจ้าของระบบ เฝ้าดูผ่านหน้าจอ ตั้งค่ากติกา/งบ กดเปิด-ปิดทารก อ่านรายงานครูใหญ่ แต่แก้ความรู้ไม่ได้ |
...
7. **ห้องครูใหญ่** — กล่องคำร้องของนักเรียน สถานะงานของครูใหญ่ (คำร้องไหนกำลังทำ
   PR ไหนรอทดสอบ/merge แล้ว) รายงานทุกฉบับ สมุดบันทึกการกระทำ และปุ่ม rollback /
   พักงานครูใหญ่ (ข้อ 9.4)
8. **ตั้งค่า (ที่เดียวที่คนสร้างแตะได้)** — ค่ากติกา รายชื่อเหรียญ ความถี่รอบ/เพดานการใช้งาน
   จัดการทารก (สร้างใหม่พร้อมสุ่มนิสัย พักงาน เก็บเข้ากรุ) โหมดครูใหญ่
...
### 9.4 ครูใหญ่ (Principal) — ผู้ดูแลโรงเรียน

โรงเรียนนี้ไม่มีครูสอน แต่มี**ครูใหญ่หนึ่งคน** — AI อีกตัวที่แยกจากนักเรียนโดยสิ้นเชิง:
ไม่เทรด ไม่มีสมองความรู้เทรด ไม่เข้าคาบเรียน หน้าที่คือช่วยคนสร้างดูแลนักเรียน
และดูแล*ตัวอาคารโรงเรียน* — ก็คือโค้ดของแอปนี้เอง
...
- **เขตหวงห้าม** ที่ครูใหญ่แตะไม่ได้เด็ดขาด (แก้ได้เฉพาะคนสร้างลงมือเอง):
  - ระบบกติกาบ้าน (ข้อ 6.1) และทุกอย่างที่เกี่ยวกับการส่งคำสั่งเงินจริง
...
- **ครูใหญ่: Claude Agent SDK อีกตัว** ที่มีสิทธิ์เข้าถึงโค้ดของแอป (git) —
  ทำงานผ่านวงจร branch → PR → ชุดทดสอบอัตโนมัติ (CI) → merge → deploy
...
- **ครูใหญ่เต็มตัว**: กล่องคำร้อง → แก้โค้ด → merge อัตโนมัติ → รายงานคนสร้าง
  พร้อมเขตหวงห้าม ตาข่ายนิรภัย และห้องครูใหญ่บนหน้าจอ (ข้อ 9.4)
